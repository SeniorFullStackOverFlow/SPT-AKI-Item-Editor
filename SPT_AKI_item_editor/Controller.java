                ...
                if (lmWrkTp == 3) {
                    if (lmWrkmd == 1) {
                        ...
                        try {
                            ...
                            BW.flush();
                            for (int i = lmAlrdScn; i < lmLnNmbr; i++) {
                                ++lmAlrdScn;
                                scanner.nextLine();
                            }
                            lmScnLn = scanner.nextLine();
                            System.out.println(lmScnLn);
                            if (lmScnLn.contains("\"_proto\":")) {
                                ...
                                do {
                                    lmScnLn = scanner.nextLine();
                                    if (lmScnLn.contains("\"_proto\":")) break;
                                    lmChk++;
                                    if (lmScnLn.contains("\"_name\":")) {
                                        lmAlrdScn = lmChk - 3;
                                        lmChk = 400;
                                    }
                                    if (lmChk == 400) break;
                                ...
                                if (lmScnLn.contains("\"_proto\":")) {
                                    ...
                                    for (int i = 0; i < lmAlrdScn; i++) {
                                        scanner.nextLine();
                                    }
                                    BW.write("},");
                                    BW.newLine();
                                    System.out.println("Содержание ссылки: " + vluespnLinkLabel1.getText());
                                    BW.write("\"_proto\": \"" + vluespnLinkLabel1.getText() + "\"");
                                    BW.newLine();
                                    BW.write("},");
                                    BW.newLine();
                                }
